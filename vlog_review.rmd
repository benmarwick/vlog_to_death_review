...
In this review I evaluate the how Tong et al. used video of archaeological fieldwork as a method for members of Project Eliseg to communicate with the public. This review has three parts. First, to give context to the Tong et al. study I use text mining methods to briefly survey how video is discussed by archaeologists. Second, I describe the aims, the structure and content of the videos in the Project Eliseg. Third, I analyse the strengths and weaknesses of their method using a model of public engagement.
